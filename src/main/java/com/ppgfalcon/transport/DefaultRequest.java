...
import static com.ppgfalcon.config.GoogleAnalyticsParameter.CURRENCY_CODE;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.DNS_TIME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.EVENT_ACTION;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.EVENT_CATEGORY;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.EVENT_LABEL;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.EVENT_VALUE;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.EXCEPTION_DESCRIPTION;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.EXCEPTION_FATAL;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.ITEM_CATEGORY;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.ITEM_CODE;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.ITEM_NAME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.ITEM_PRICE;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.ITEM_QUANTITY;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.PAGE_DOWNLOAD_TIME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.PAGE_LOAD_TIME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.REDIRECT_RESPONSE_TIME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.SERVER_RESPONSE_TIME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.SOCIAL_ACTION;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.SOCIAL_ACTION_TARGET;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.SOCIAL_NETWORK;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.TCP_CONNECT_TIME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.TRANSACTION_AFFILIATION;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.TRANSACTION_ID;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.TRANSACTION_REVENUE;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.TRANSACTION_SHIPPING;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.TRANSACTION_TAX;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.USER_TIMING_CATEGORY;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.USER_TIMING_LABEL;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.USER_TIMING_TIME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.USER_TIMING_VARIABLE_NAME;
