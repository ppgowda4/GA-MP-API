...
import static com.gamp.config.GoogleAnalyticsParameter.ADWORDS_ID;
import static com.gamp.config.GoogleAnalyticsParameter.ANONYMIZE_IP;
import static com.gamp.config.GoogleAnalyticsParameter.APPLICATION_ID;
import static com.gamp.config.GoogleAnalyticsParameter.APPLICATION_NAME;
import static com.gamp.config.GoogleAnalyticsParameter.APPLICATION_VERSION;
import static com.gamp.config.GoogleAnalyticsParameter.CACHE_BUSTER;
import static com.gamp.config.GoogleAnalyticsParameter.CAMPAIGN_CONTENT;
import static com.gamp.config.GoogleAnalyticsParameter.CAMPAIGN_ID;
import static com.gamp.config.GoogleAnalyticsParameter.CAMPAIGN_KEYWORD;
import static com.gamp.config.GoogleAnalyticsParameter.CAMPAIGN_MEDIUM;
import static com.gamp.config.GoogleAnalyticsParameter.CAMPAIGN_NAME;
import static com.gamp.config.GoogleAnalyticsParameter.CAMPAIGN_SOURCE;
import static com.gamp.config.GoogleAnalyticsParameter.CLIENT_ID;
import static com.gamp.config.GoogleAnalyticsParameter.CONTENT_DESCRIPTION;
import static com.gamp.config.GoogleAnalyticsParameter.DATA_SOURCE;
import static com.gamp.config.GoogleAnalyticsParameter.DISPLAY_ADS_ID;
import static com.gamp.config.GoogleAnalyticsParameter.DOCUMENT_ENCODING;
import static com.gamp.config.GoogleAnalyticsParameter.DOCUMENT_HOST_NAME;
import static com.gamp.config.GoogleAnalyticsParameter.DOCUMENT_PATH;
import static com.gamp.config.GoogleAnalyticsParameter.DOCUMENT_REFERRER;
import static com.gamp.config.GoogleAnalyticsParameter.DOCUMENT_TITLE;
import static com.gamp.config.GoogleAnalyticsParameter.DOCUMENT_URL;
import static com.gamp.config.GoogleAnalyticsParameter.EXPERIMENT_ID;
import static com.gamp.config.GoogleAnalyticsParameter.EXPERIMENT_VARIANT;
import static com.gamp.config.GoogleAnalyticsParameter.FLASH_VERSION;
import static com.gamp.config.GoogleAnalyticsParameter.HIT_TYPE;
import static com.gamp.config.GoogleAnalyticsParameter.JAVA_ENABLED;
import static com.gamp.config.GoogleAnalyticsParameter.NON_INTERACTION_HIT;
import static com.gamp.config.GoogleAnalyticsParameter.PROTOCOL_VERSION;
import static com.gamp.config.GoogleAnalyticsParameter.QUEUE_TIME;
import static com.gamp.config.GoogleAnalyticsParameter.SCREEN_COLORS;
import static com.gamp.config.GoogleAnalyticsParameter.SCREEN_RESOLUTION;
import static com.gamp.config.GoogleAnalyticsParameter.SESSION_CONTROL;
import static com.gamp.config.GoogleAnalyticsParameter.TRACKING_ID;
import static com.gamp.config.GoogleAnalyticsParameter.USER_ID;
import static com.gamp.config.GoogleAnalyticsParameter.USER_LANGUAGE;
import static com.gamp.config.GoogleAnalyticsParameter.VIEWPORT_SIZE;
