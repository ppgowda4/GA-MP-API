...
import static com.ppgfalcon.config.GoogleAnalyticsParameter.ADWORDS_ID;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.ANONYMIZE_IP;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.APPLICATION_ID;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.APPLICATION_NAME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.APPLICATION_VERSION;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.CACHE_BUSTER;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.CAMPAIGN_CONTENT;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.CAMPAIGN_ID;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.CAMPAIGN_KEYWORD;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.CAMPAIGN_MEDIUM;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.CAMPAIGN_NAME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.CAMPAIGN_SOURCE;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.CLIENT_ID;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.CONTENT_DESCRIPTION;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.DATA_SOURCE;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.DISPLAY_ADS_ID;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.DOCUMENT_ENCODING;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.DOCUMENT_HOST_NAME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.DOCUMENT_PATH;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.DOCUMENT_REFERRER;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.DOCUMENT_TITLE;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.DOCUMENT_URL;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.EXPERIMENT_ID;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.EXPERIMENT_VARIANT;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.FLASH_VERSION;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.HIT_TYPE;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.JAVA_ENABLED;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.NON_INTERACTION_HIT;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.PROTOCOL_VERSION;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.QUEUE_TIME;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.SCREEN_COLORS;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.SCREEN_RESOLUTION;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.SESSION_CONTROL;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.TRACKING_ID;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.USER_ID;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.USER_LANGUAGE;
import static com.ppgfalcon.config.GoogleAnalyticsParameter.VIEWPORT_SIZE;

import java.util.HashMap;
import java.util.Map;

import com.ppgfalcon.config.GoogleAnalyticsParameter;
...
public class GoogleAnalyticsRequest<T> {
	...
	public GoogleAnalyticsRequest(String hitType, String trackingId, boolean isMobileApp, String appName, String appVersion) {
	...
	public T isMobileApp(boolean value) {
		//setString(TRACKING_ID, value);
	   	return (T) this;
	}
